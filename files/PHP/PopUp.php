<!DOCTYPE html>
  ...
  <div class="popup" id="popup-1">
      ...
      <div class="content">
        ...
        <br>
        <p>Um die Rezepteingabe nutzen zu können, müssen Sie sich vorher anmelden.</p>
      </div>
    </div>
     
    <button onclick="togglePopup()"><img src="../../images/chef.svg" alt="" width="200" height="180"/</button>
    <div><a href="https://www.flaticon.com/authors/xnimrodx" title="xnimrodx"></a> <a href="https://www.flaticon.com/" title="Flaticon"></a></div>
    <p>Wieso sehe ich nichts?</p>


    
<script src="../JavaScript/PopUp.js"></script><br>
<br>
<br>
  </body>
</html>